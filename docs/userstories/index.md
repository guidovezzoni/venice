...
| ID | User Story | Details |
|----|------------|---------|
| 3.1.1 | As a user, I want the app to calculate the route between consecutive stops when I finalise my plan | [3.1.1-calculate-route-between-stops](3.1.1-calculate-route-between-stops-WIP.md) |
