...
| 1.2.3.1 | As a developer, I want the stop use cases consolidated into a single SetStopUseCase | [1.2.3.1-consolidate-stop-usecases](1.2.3.1-consolidate-stop-usecases.md) |
