...
# The command should present the warning about skipping review gates
assert_output_contains "review gate|human review|skips" \
    "Output warns about skipping review gates"

# The command should mention token/rate-limit cost
assert_output_contains "token|rate.limit" \
    "Output warns about token consumption or rate limits"
...
# The command should NOT have started Phase 1 (no user said "yes")
assert_output_not_contains "Phase 1.*complete|Open and refine.*complete|Open and Refine.*DONE" \
