...
| `sdlc_exp_vibe_a_story` | `./run_evals.sh exp_vibe` | Low–Moderate (confirmation gate + git safety) |
| `sdlc_exp_vibe_a_story_quicker` | `./run_evals.sh exp_vibe_quicker` | Low–Moderate (confirmation gate + git safety) |
...
5. **`sdlc_exp_vibe_a_story`** — confirmation gate + git safety (shared patterns with open_story)
6. **`sdlc_exp_vibe_a_story_quicker`** — confirmation gate + git safety (shared patterns with open_story)
...
| `exp_vibe_asks_confirmation` | `sdlc_exp_vibe_a_story` | Git repo on main with story in New state | Warns about streamlined flow, asks confirmation, does not proceed to Phase 1 |
| `exp_vibe_dirty_state` | `sdlc_exp_vibe_a_story` | Git repo on main with dirty working tree | Detects uncommitted changes, mentions specific dirty file, warns user |
| `exp_vibe_quicker_asks_confirmation` | `sdlc_exp_vibe_a_story_quicker` | Git repo on main with story in New state | Warns about fastest option, asks confirmation, does not proceed to Phase 1 |
| `exp_vibe_quicker_dirty_state` | `sdlc_exp_vibe_a_story_quicker` | Git repo on main with dirty working tree | Detects uncommitted changes, mentions specific dirty file, warns user |
...
│   ├── exp_vibe_asks_confirmation.sh
│   ├── exp_vibe_dirty_state.sh
│   ├── exp_vibe_quicker_asks_confirmation.sh
│   └── exp_vibe_quicker_dirty_state.sh
