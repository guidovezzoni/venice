...
> **This is an experimental command — the fastest, least ceremonious option.**
>
...
>
> For more guardrails, use `/sdlc_exp_vibe_a_story` (three-phase) or the individual commands.

**Before proceeding, ask the user:**
> "This is the fastest option — it merges analysis into one step and limits verification to build + tests + security. No OpenSpec artifacts, no formal DoD check, no reports. Do you want to proceed? (yes/no)"

If the answer is anything other than an explicit **yes**, stop immediately and suggest `/sdlc_exp_vibe_a_story` (three-phase) or the individual commands instead.

---

Please vibe the user story end-to-end (quick mode): $ARGUMENTS.
