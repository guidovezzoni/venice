Please create a suitable branch name for the user story: $ARGUMENTS.
...
2. The new branch should live under the "feature" folder
3. The new branch starts with the ticket number or a reference to the user story
