...
- Epic 3 / Feature 3.2: Trip totals — 3.2.1 (see total distance: derived sum of leg distances shown in TripTotalSummary composable, locale-aware formatting, "unavailable" when route not complete)
