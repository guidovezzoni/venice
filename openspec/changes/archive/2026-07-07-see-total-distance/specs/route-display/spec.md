...
- `trip_detail_total_distance_unavailable`: "Total distance unavailable" — displayed in place of the label/value pair when the route is not complete

#### Scenario: String resources defined
- **WHEN** the app is built
- **THEN** all route calculation string resources, including `trip_detail_leg_distance_miles`, `trip_detail_total_distance_label`, and `trip_detail_total_distance_unavailable`, resolve without errors in all supported locales (English, Italian, Spanish)
