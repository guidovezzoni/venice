# Intermediate Stop Management

## Purpose

Defines the use case for adding intermediate stops to a trip, including validation of inputs and delegation to the repository layer.
