...
Defines the domain models, repository interface and implementation, mappers, use cases, and DI wiring for resolving place names to geographic coordinates via the Google Places Autocomplete (New) API.
